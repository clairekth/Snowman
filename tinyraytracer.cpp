...
int main()
{
	...
	// yeux
	spheres.push_back(Sphere(Vec3f(0.5, 4.5, -16.7), 0.23, red_rubber));
	spheres.push_back(Sphere(Vec3f(-0.5, 4.5, -16.7), 0.23, red_rubber));
	// boutons
	spheres.push_back(Sphere(Vec3f(0, 2., -16.07), 0.2, ivory));
	spheres.push_back(Sphere(Vec3f(0, 1.1, -16.1), 0.2, ivory));
	spheres.push_back(Sphere(Vec3f(0, -0.5, -15.9), 0.2, ivory));
	spheres.push_back(Sphere(Vec3f(0, -1.2, -15.6), 0.2, ivory));
